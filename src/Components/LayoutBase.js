  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex h-full w-full select-none flex-col items-center gap-6 rounded-xl bg-[--clr-cont] px-4 py-2 text-center shadow-lg ring ring-inset ring-[--clr-prim] md:justify-evenly md:gap-2 md:px-6"
      >
        {!casuale && (
