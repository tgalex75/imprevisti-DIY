...
const RegistroGiocatori = (props) => {
  const { registroGiocatori, deleteListDB, removeVociRegistro, tipoImprevisto } =
    props;
  return (
    <motion.div
      initial={{ opacity: 0 }}
      ...
      className="absolute left-1 top-1/2 hidden h-[99%] w-[15vw] -translate-y-1/2 flex-col items-center justify-between overflow-hidden rounded-lg bg-black/50 pt-2 text-gray-300 md:flex md:flex-col"
    >
